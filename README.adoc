...
.図の名前を変更する
image::images/GSW-20190930-002210_0.png[{three-quarters-width}]
...
image::images/sample01_class_01.png[{full-width}]
...
.クラス図とコードの対応づけ
image::images/traslation_rule_guide.png[{full-width}]
...
. config (motor)
. stop (motor)
. is_pressed (touch_sensor)
. tslp_tsk (OS)
. ext_tsk (OS)
. is_loaded (carrier)
. is_detected (walldetector)
. tracer_run (tracer)
. tracer_stop (tracer)
. is_pushed (bumper)
. is_online (linemon)
. driver_turn_left (driver)
. driver_turn_right (driver)
. driver_stop (driver)
. transport (porter)
. get_refletc (color_sensor)
. get_distance (ultrasonic_sensor)
...
. porter → bumper
. porter → tracer
. walldetector → ultrasonic_sensor
. carrier → touch_sensor
. bumper → touch_sensor
. tracer → driver
. driver → motor
. linemon → color_sensor
...
image::images/sample04_class_01.png[{full-width}]
...
image::images/sample04_class_02.png[{full-width}]
...
image::images/GSW-20191021-102644.png["add_stm_diagram", {half-width}]]

[[add_stm_name]]
.ステートマシン図に名前をつける
image::images/GSW-20191021-102135.png["add_stm_name", {half-width}]]
...
.作成中のステートマシン図
image::images/GSW-20191021-142110.png[{three-quarters-width}]
...
image::images/sample04_stms_01.png[{full-width}]
...
image::images/layered_arch.png[{three-quarters-width}]
...
.タイマークラス
image::images/timer.png[{one-quarters-width}]
...
.ホーンクラス
image::images/horn.png[{one-quarters-width}]
...
[[timer_horn_usage]]
.timerとhornの利用例
image::images/timer_horn_usage02.png[{full-width}]
...
image::images/sample04-01_class_01.png[{full-width}]
...
image::images/sample04-01_stms_01.png[{full-width}]
...
image::images/sample04-02_class_01.png[{full-width}]
...
image::images/sample04-02_stms_01.png[{full-width}]
